...
def getFLICData(train_set_ratio=0.8,validation_set_ratio = 0.1):
    ...
    for i, example in enumerate(examples):
        ...
        image_path = './FLIC/images/'+image_name
    ...
    train_validation_split = int(len(label_list)*train_set_ratio)
    validation_test_split = int(len(label_list)*(train_set_ratio+validation_set_ratio))
