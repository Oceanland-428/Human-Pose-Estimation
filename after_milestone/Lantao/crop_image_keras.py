...
#         #print("1: ", temp_image.shape, int(reshape_size[0,i]), int(reshape_size[1,i]), i)
#         # get the actual image size
#         temp_image_weight, temp_image_height,_ = temp_image.shape
#         #print(actual_reshape_size)
#         actual_reshape_size[0,i] = tf.to_float(temp_image_weight)
#         actual_reshape_size[1,i] = tf.to_float(temp_image_height)
...
#     return crop_image_list,actual_reshape_size
    for i in range(yshape1):
        ...
        # get the actual image size
        temp_image_height, temp_image_width,_ = temp_image.shape
        actual_reshape_size[0,i] = temp_image_width
...
def scale_label(label, original_width,original_height):
...
#         reshape_size = tf.convert_to_tensor(reshape_size, np.float32)
#         #print(reshape_size)
#         #print(images[i])
#         #print(pred_label)
...
#     return crop_image_matrix,actual_reshape_size_matrix
def images_crop(images,Y_preds,Y_trues):
    '''
    Inputs: images is a list of length N and each element has shape 227*227*3
            Y_preds is a matrix of shape(N,2,14) for lsp dataset
